...
private val MIGRATION_95_96_DROP_MATCH_SET_RESULTS = migration(
    95,
    96,
    listOf(
        "ALTER TABLE `MatchMVP` DROP COLUMN `setResults`",
    ),
)

internal val IOS_MVP_DATABASE_MIGRATIONS_V32_TO_V96: Array<Migration> = arrayOf(
